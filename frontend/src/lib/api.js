...
export const registerApplicant = (payload) =>
  post("/api/applicants/register", payload);

export const getApplicantStatus = (email) =>
  get("/api/applicants/me", { email });

export const getProgrammeFees = () => get("/api/applicants/fees");

export const payAdmissionFee = (payload) =>
  post("/api/payments/admission", payload);
...
export const updateFaculty = (id, payload) =>
  patch(`/api/faculty/${id}`, payload);
...
export const setAttendance = (
  holderId,
  { date, status, holderType = "student" },
...
export const revokeCard = (cardId) =>
  del(`/api/cards/${encodeURIComponent(cardId)}`);

export const getCourses = (params) => get("/api/courses", params);
export const createCourse = (payload) => post("/api/courses", payload);
export const updateCourse = (code, payload) =>
  patch(`/api/courses/${code}`, payload);
...
export const setTimetableSlot = (payload) =>
  put("/api/timetable/slot", payload);
...
export const requestHandoff = (payload) =>
  post("/api/support/handoff", payload);
